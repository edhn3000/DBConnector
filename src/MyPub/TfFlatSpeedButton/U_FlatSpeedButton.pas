...
procedure Register;
begin
  RegisterComponents('fControls', [TFlatSpeedButton]);
end;
...
procedure TFlatSpeedButton.SetTransparent(Value: Boolean);
begin
...
procedure TFlatSpeedButton.SetFlat(Value: Boolean);
begin
  if Value <> FFlat then
  begin
    FFlat := Value;
