...
const CERT_NAME_ISSUER_FLAG = $00000001;
...
function CertGetNameStringA(pCertContext: PCCERT_CONTEXT;
                            dwType, dwFlags: DWORD; pvTypePara: PVOID;
                            pszNameString: LPSTR; cchNameString: DWORD):DWORD ; stdcall;

function CertGetNameStringW(pCertContext: PCCERT_CONTEXT;
                            dwType, dwFlags: DWORD; pvTypePara: PVOID;
                            pszNameString: LPWSTR; cchNameString: DWORD):DWORD ; stdcall;
